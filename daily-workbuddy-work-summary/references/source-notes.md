...
Use these local files as evidence for daily WorkBuddy summaries:

- `~/.workbuddy/memory/YYYY-MM-DD.md`: Daily memory files. WorkBuddy appends a brief note here after completing substantive work each session. These are the primary source of truth for daily summaries.
